...
public class RechargeRecordDTO extends BaseDTO{
     ...
     * 停车场ID
     */
    //@NotEmpty(message = "parkId不能为空")
    private Integer parkId;

    /**
     * 卡片ID
     */
    //@NotEmpty(message = "cardId不能为空")
    ...
    public RechargeRecordDTO(String companyId, Integer parkId, String cardId, String orderNo, Integer carType, Integer payChannel, Integer chargeMethod, String chargeNumber, String amount, Integer freeNumber, String validFrom, String validTo, String createTime, String remark, Integer rechargeType, Integer operationType, String operator, String paySource) {
        super();
    }
}
